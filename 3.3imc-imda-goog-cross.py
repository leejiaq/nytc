...
if not uapi.connect():
    ...
    uapi.single_fly_up(int(200/CM)) # y: 300 cm
    uapi.single_fly_forward(int(120/CM))
    time.sleep(2)
    uapi.single_fly_forward(int(70/CM))
    uapi.single_fly_back(int(120/CM))
    ...
    logo_target = ""
    align = False
    uapi.single_fly_touchdown() # y-dist: 220 cm
    time.sleep(10)
    ...
    logo_target = ""
    align = False
    uapi.single_fly_touchdown() # y-dist: 150 cm
    time.sleep(10)

    uapi.single_fly_takeoff() # +y: 100, 250 cm
    uapi.single_fly_up(int(50/CM)) # y: 300 cm
    ...
    logo_target = ""
    align = False
    uapi.single_fly_touchdown() # y-dist: 200 cm
    time.sleep(10)

    uapi.single_fly_takeoff() # +y: 100, 200 cm
    uapi.single_fly_up(int(100/CM)) # y: 300 cm
    ...
    logo_target = ""
    align = False
    uapi.single_fly_touchdown() # y-dist: 240 cm
    time.sleep(10)
